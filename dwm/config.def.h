...
static const int systraypinningfailfirst = 1;   /* 1: if pinning fails, display systray on the first monitor, False: display systray on the last monitor */ static const int showsystray        = 1;     /* 0 means no systray */ static const int showbar            = 0;        /* 0 means no bar */
...
static const char *powermenu2[] = { "/home/cleff/.config/rofi/powermenu/powermenu.sh", NULL };

/* lockscreen */
//static const char *lockcmd[] = { "slock", NULL };

/* screenshot */
static const char *screenshot[] = {"scrot", "-s", "/home/cleff/Pictures/Screenshots/%d-%m-%Y-%T-screenshot.jpg", NULL };
...
static const Layout layouts[] = {
	/* symbol     arrange function */ { "=",      tile },    /* first entry is default */ { "o",      NULL },    /* no layout function means floating behavior */ { "M",      monocle },
};
...
/* helper for spawning shell commands in the pre dwm-5.0 fashion */ #define SHCMD(cmd) { .v = (const char*[]){ "st", "-c", cmd, NULL } }
...
static const char *roficmd2[] = { "/home/cleff/.config/rofi/launcher/launcher.sh", NULL };
